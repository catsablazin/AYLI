...
label introduction:
    ...
    galleryunlock cg1
    scene black with fade
    #scene cg uncon hacku with fade
...
label checkHacku:
    ...
    menu:
        ...
        "Talk to Hacku":
            ...
            reader "Ok!"
            hide hacky smile with dissolve
            ...
            "Open vent" if vent:
                ...
                menu:
                    ...
                    "Sniff it":
                        ...
                        #hide hacku smile with dissolve
...
label checkRai:
    ...
    menu:
        ...
        "Talk to Rai":
            ...
            show rai neutral with dissolve
            reader "Hey Rai."
            ...
            hide rai thinking with dissolve
    ...
    while raiClues != 4:
        menu:
            ...
            "Rug" if rug:
                ...
                play sound "footsteps short.mp3"
                "You walk over to the rug in the middle of the room."

                if cabinUgly:
                    reader "..."
                    reader "{i}That is a very tacky rug. Whoever was the interior decorator should be fired.{i}"
                else:
                    reader "{i}Cute rug.{i}"
                    reader "{i}Wonder why they would put something nice in here though.{i}"
...
label checkHali:
    ...
    menu:
        ...
        "Talk to Hali":
            ...
            "Hali seems to dislike you a little more."
...
label checkVyn:
    ...
    menu:
        ...
        "Talk to Vyn":
            show vyn neutral with dissolve
            reader "Sup Vyn!"
            ...
            v "I didn't't want to dance so I opted to do something else."
            show vyn happy
            ...
            hide vyn thinking with dissolve
            ...
            "Broken chair" if diningRug:
                ...
                menu:
                    ...
                    "Ask Vyn":
                        ...
                        show vyn thinking with dissolve
                        v "Sup bro."
                        show vyn neutral
                        ...
                        hide vyn neutral with dissolve
...
label argument:
    ...
    show hacku thinking at seveneight
    with moveinright
...
label bad_ending_3:
    ...
    hk "Calm down! All this yelling isn't "

    "They keep arguing. But all the sound drowns."
    reader "..."
    reader "..."
    #scene blurry
...
label true_ending:
    ...
    "Hacku's colleague" "If you would follow me please."
