...
define BOBCGALLERY_MANUAL_CGS = (
    ...
    #("cg8", "cg raivslucy"),
    #("cg9", "cg hacku accues"),
    #("cg10", "cg bad ending 0"),
    #("cg11", "cg bad ending 1"),
    #("cg12", "cg bad ending 2"),
    #("cg13", "cg bad ending 3"),
    #("cg14", "cg good ending"),
    #("cg15", "cg true ending")
    ...
    # example image with three variants
...
image bobcgallery_locked_cg = Transform("#e40000", xysize=(BOBCGALLERY_THUMB_XMAXIMUM, BOBCGALLERY_THUMB_YMAXIMUM))
