...
screen main_menu():
    ...
    vbox:
        ...
        imagemap:
            ground "gui/ayli_ground.png"
            idle "gui/ayli_ground.png"
            hover "gui/ayli_hover.png"
            selected_hover "gui/ayli_selected_hover.png"
            selected_idle "gui/ayli_hover.png"

            hotspot (54, 324, 273, 71) action Start()
            hotspot (76, 417, 261, 79) action ShowMenu("load")
            hotspot (86, 517, 254, 74) action ShowMenu("bobcgallery")
            hotspot (95, 625, 274, 72) action ShowMenu('preferences')
            hotspot (83, 722, 228, 72) action ShowMenu('about')
            hotspot (93, 817, 240, 76) action ShowMenu('help')
            hotspot (78, 923, 248, 76) action Quit(confirm = not main_menu)
