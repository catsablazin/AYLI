...
label start:
    ...
    "There will also be LOUD noises and sound effects. You can disable or lower the volume in the options menu."
    "There is a mechanic called trust. During certain choice events, your trust with the charactor will be indicated in the top left-hand corner along with the name of the charactor."
    ...
    play music "ringing.mp3" fadein 1.0 loop
    scene black
    "..."
    ...
    queue music "bgm.mp3" fadein 1.0 volume 0.35 loop
...
label checkLucy:
    ...
    scene bg garage lucy with fade
            ...
            "Trashcan" if trash:
                ...
                menu:
                    ...
                    "Yes":
                        ...
                        reader "{i}Woah, this looked like a really good quailty camera too.{i}"
                        ...
                        "You leave the camera in the trashcan for now and make sure that none of the glass got on the floor."
            ...
            "Counter tops" if counter:
                ...
                menu:
                    ...
                    "Look closer":
                        ...
                        show hali huh at left
                        show bg kitchen
                        with dissolve
                        ha "!!!"

                        if haliAngry:
                            show hali shocked at five
                            with move
...
label argument:
    ...
    show hali annoyed
    ha "The hell?"
    ha "How are you two together?"
    show hali rbf

    show lucy sad
    l "There was a secret passage I found after [readerName] left.."
    l "It led to the living room where Rai was.."
    show lucy scared

    show rai enraged
    r "Ugh! That doesn't matter right now!"
    r "You knew his name and you never said anything!"
    show rai pissed
    ...
    play sound "open door.mp3"
    queue sound "footsteps short.mp3"
        ...
        while clues != numClues:
            menu:
                ...
                "White hair" if hair:
                    ...
                    show hacku thinking
                    hk "Ah yea."
                    hk "There were some bruises on his kuckles."
                    show hacku neutral
                    
                    reader "Mhm."
                    reader "But, I feel like a big guy like him wouldn't go down without a fight."
                    reader "I think that the person who was fighting also got injuried, which is why there were different colored hair."
                    ...
                    show vyn happy
                    v "Wait!"
                    v "That broken chair in the room!"
                    show vyn thinking
                    v "If you just hit that over the head, you'd knock out anyone!"
                    show vyn neutral
                    ...
                    show hali enraged
                    ha "OH MY GOD!"
                    ha "No one gives a fuck about your stories!"
                    ha "The point is we know he was knocked out and that's how he was killed."
                    show hali pissed

                    reader "Yea.."
                    reader "{i}Best to move on before these two rip each other's heads off.{i}"
...
label bad_ending_1:
    ...
    queue sound "punch.mp3" volume 1.0
    scene black with fade

    stop music fadeout 1.0
    queue music "ringing.mp3" fadein 1.0 loop
...
label good_ending:
    ...
    show mentor
    show hali neutral at one
    show lucy neutral at three
    show vyn neutral at six
    show rai neutral at eightseven
    with dissolve
    ...
    "The assistant came outside of the door that they opened with an unconscious Hacku."
    ...
    scene cg reader neutral with fade
    ...
    show cg reader smile with dissolve
    "You smile."
...
label true_ending:
    ...
    "Hah."
    show cg reader far with dissolve
    ...
    show cg reader close with dissolve
    reader "Hmm.."
    ...
    hk "{i}This guy is so annoying.{i}"
    hk "Ugh.."
    ...
    hk "[readerName], if we can even call you that, what do you want?"

    reader "Hahahah! You'll find out."

    r "UGH! I'm going to knock them out."

    hk "Wait! We need to find a phone, or a way out of here before that."

    r "Did you not hear? [readerName] killed someone! Probably more than we know!"

    reader "Oh, please take your time."
    ...
    show rai pissed at three 
    show lucy scared at six
    show hali huh at eightseven
    with dissolve

    hk "Ah-"

    show rai enraged
    r "Sometimes, it's just best to question the murderer later."
    show rai pissed
    ...
    show rai annoyed
    r "Who knows what they could have pulled!"
    r "They're already good at acting because I swear.."
    show rai rbf
    ...
    hk "We should look for a way to communicte with an outside or just a way out."
    hk "I can contact my mentor to come."
    ...
    show hali enraged at six
    show lucy at eightseven
    with move
    show rai pissed
    ...
    show hali happy
    ha "Can you show us where the emergency phone is?"
    show hali smile
    ...
    "Lucy started to lead Hali and you to the fireplace."
    "She pushed one of the rocks and it clicked open, revealing an old wired phone."
    ...
    play sound "calling.mp3"
    "You punched in your mentor's number into the phone."

    hk "Hello sir!"

    "Mentor" "Hey Hacku! To what do I own the pleasure?"

    hk "I found the murderer."

    "Mentor" "HUH?"

    show vyn happy
    v "LOL, I could hear that from all the way over here!"
    show vyn smile

    "Mentor" "How- Ok, I'll ask the details later. Where are you currently."

    hk "{i}Crap, I don't even know that.{i}"
    hk "{i}Wait! Lucy!{i}"
    hk "Lucy! I need you to tell me the address of this place."
    ...
    show mentor with dissolve

    "Mentor" "My god Hacku! I can't believe you actually found them."
    "Mentor" "We can rub it in the other detectives faces now."
    "Mentor" "AHAHAH!"

    hk "Pft- don't get ahead of yourself, old man."
    hk "There is still other things we need to check."

    "Mentor" "Ugh, paperwork."
    "Mentor" "I'm going to go check with the police to see where we're at with the outside investigation."

    hk "Ok!"

    "Mentor" "Oh, and that girl Lucy."
    "Mentor" "She's with Ms. Myushi right now."

    hk "Oh, why?"

    "Mentor" "She's underage, so we'll need to contact her parents."
    "Mentor" "But, I have a small feeling that her parents aren't going to be very.. nice."
    "Mentor" "Considering what you told me about her relationship is with the murdered."

    hk "Who was always in kahoots with [readerName]."

    "Mentor" "Yep. So she's in witness protection right now."
    "Mentor" "But she'll have to go through extra questioning."

    hk "Alright, I'll tell the others this if that's ok."

    "Mentor" "All good."

    show mentor at offright
    with move

    hide mentor
    show vyn neutral at onetwo
    show rai neutral at threefour
    show hali neutral at six
    with dissolve

    show hali happy
    ha "Man, it's so good to be outside."
    show hali smile
    ...
    show rai thinking
    r "By the way Hacku, [readerName] woke up."
    show rai neutral

    show vyn thinking
    v "Oh shit!"
    v "Is that [readerName] over there sitting?"
    show vyn neutral

    show rai thinking
    r "Yea."
    show rai annoyed
    r "So if you want to talk to that murderer.."
    r "I already tied [readerName]'s hands so don't worry about the bitch getting away."
    show rai rbf

    hk "I will actually. I still have some questions about this entire thing."

    play sound "walk grass.mp3"
    scene cg outside with fade

    hk "[readerName]."

    reader "Ugh, that Rai sure knows how to punch."
    reader "Not that it mattered though."

    hk "Why did you kill Shugo?"

    reader "It's soooo boring just to tell you though!"
    reader "But considering I wasn't expecting to get arrested or knocked out, I'll level with you."

    hk "{i}Wasn't expecting to get arrested?{i}"

    reader "It was never in my plan to get this many people involved."
    reader "Those three were just there because they happened to wonder into the house."
    reader "Lucy, on the other hand, was already there."

    hk "!!"

    reader "She's just a kid though, so I'm sure she didn't think much of it."
    reader "Shugo is good friends with her big brother after all."
    reader "But, it was all just to lure out that mentor of yours."

    hk "Huh? My mentor?"

    reader "Hah."
    reader "Anyways, he was a liability to me."
    reader "But the bastard didn't tell me he made an entire escape room in that house."
    reader "Getting this many people dragged into this plan."
    reader "Such a rookie move."

    hk "What did you want with my mentor?!"
    hk "And what about Lucy?"
    ...
    show cg outside empty with dissolve
    play sound "run grass.mp3"
    ...
    hk "{i}!!!{i}"
    hk "{i}Where is the body?!{i}"
    hk "CRAP! Ugh, they got me good."

    show rai thinking at onetwo
    with moveinright
    ...
    show hali thinking at seven
    show vyn neutral at eight
    with moveinright
    ...
    "Mentor" "Hak! Why'd you go back in there?"

    hk "The inspectors were knocked out and the body is gone."

    "Mentor" "Huh?!"

    hk "Yea."

    "Mentor" "Jeez, there is always some shit that happens."

    hk "Hahah! I told you that it wouldn't be easy."

    "Mentor" "Yeah yeah. Ugh, I should be telling you that."
    "Mentor" "I guess I've been behind the desk for too long."
    "Mentor" "Anyways, Hali, Vyn and Rai, if you would follow me whenever you're ready."

    hide mentor 
    show mentor at offleft
    with move
    ...
    hk "But, because she is still a minor, she won't be punished or treated harshly if you think that will happen."
...
label endCredits:
    stop music fadeout 1.0
    queue music "ending.mp3" fadein 1.0 loop
    define me = Character("Ji")
    scene my bg with fade

    show me neutral with dissolve
    me "Hello!"

    show me happy
    me "Thank you for playing my game!"

    show me neutral
    me "I know I ended with a cliffhanger of sorts but if you know me, I love making very long stories so I may or may not make a sequel to this one."
    me "We'll see."
    me "There is more to the story and I hope to continue it one day but for now I'm going to take a long nap."

    show me point
    me "Originally, I just wanted to make a murder mystery story where the reader was the murderer all along, however.."
    
    show me happy
    me "I wrote a lot more than I planned to."
    me "I actually got my inspiration from this one episode from Bungo Stray Dogs (S2 E10) and built the story from there."
   
    show me neutral
    me "It remains to be seen if i actually make a sequel for this game or not, but I hope to one day!"

    show me happy
    me "I'd like to thank my two friends who let me use their names for this story."
    
    show me neutral
    me "AKA, they asked me if they could both be in the game."

    show me point
    show hawivyn with dissolve
    me "Thank you my besties, Vyn and Hali!"
    me "Also, to my other friends too for being my beta testers."
    me "Thank you Kani, Lin, Hali, Vyn and Wani!"
    hide hawivyn with dissolve

    show me neutral
    me "Also thanking my professor becausethisisactuallyaprojectforaclassandthatswhyitwaskindarushed but that's besides the point!"
    
    show me happy
    me "Thank you once again for playing my game, even if it was a little wonky."

    show me point 
    show juno with dissolve
    me "I really appreciate it so here's a picture of my cat."
    me "Bye bye <3!"
